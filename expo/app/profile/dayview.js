...
function Row(props) {
    ...
    return (
        <View style={styles.row.container}>
            ...
            <Text width={50} style={styles.row.text}>{props.type}</Text>
            <Text width={165} style={styles.row.text}>{props.date}</Text>
            <Text style={styles.row.text}>{Math.round(props.duration / 60)} mins</Text>
        </View>
    );
}
